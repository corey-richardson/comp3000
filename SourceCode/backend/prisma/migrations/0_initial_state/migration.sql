...
-- CreateEnum
CREATE TYPE "ScoreStatus" AS ENUM ('SUBMITTED', 'VERIFIED', 'REJECTED');
...
CREATE TABLE "Score" (
    ...
    "competition" "CompetitionStatus" NOT NULL DEFAULT 'PRACTICE',
    ...
    "numArrows" INTEGER NOT NULL DEFAULT 0,
    "sex" "Sex" NOT NULL DEFAULT 'OPEN',
    "ageCategory" "AgeCategories" NOT NULL DEFAULT 'SENIOR',
    "notes" TEXT,
    "journal" TEXT,
    "status" "ScoreStatus" NOT NULL DEFAULT 'SUBMITTED',
    "submitted_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "verifiedById" TEXT,
    "verified_at" TIMESTAMP(3),
    "classification" TEXT,
    "uncappedClassification" TEXT,
...
CREATE TABLE "BowstyleSummary" (
    ...
    CONSTRAINT "BowstyleSummary_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "BowstyleSummary_userId_bowstyle_key" ON "BowstyleSummary"("userId", "bowstyle");
...
-- AddForeignKey
ALTER TABLE "Score" ADD CONSTRAINT "Score_verifiedById_fkey" FOREIGN KEY ("verifiedById") REFERENCES "Profile"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "BowstyleSummary" ADD CONSTRAINT "BowstyleSummary_userId_fkey" FOREIGN KEY ("userId") REFERENCES "RecordsSummary"("userId") ON DELETE CASCADE ON UPDATE CASCADE;
